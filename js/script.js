$(function () {
    ...
    function addSharedNavAndFooter() {
        ...
        '<li class="nav-item"> <a class="nav-link" href="index.html#Howitworks">How It Works</a> </li>' +
        ...
        document.getElementById("footerMenu").innerHTML =
            ...
            '</div>' +
            '<div class="col-lg-2 col-7 footer-col text-left">' +
            ...
            '</div>' +
            '</div>' +
            '<div class="col-lg-2 col-5 footer-col text-left mb-3">' +
            ...
            '<p><small>COPYRIGHT © 2019. AIRSPACE SOLUTIONS, INC. ALL RIGHTS RESERVED.</small></p>' +
            '</div>' +
            '</div>';
    }
